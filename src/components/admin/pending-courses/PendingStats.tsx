    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <Card>
        <CardContent className="flex justify-between p-4">
          <div>
            <p className="text-sm text-muted-foreground">{t("newCourse")}</p>
            <p className="text-xl font-bold">{newCourses}</p>
            <p className="text-xs text-muted-foreground">{t("waitingApproval")}</p>
          </div>
      ...
      <Card>
        <CardContent className="flex justify-between p-4">
          <div>
            <p className="text-sm text-muted-foreground">{t("updatedCourse")}</p>
      ...
      <Card>
        <CardContent className="flex justify-between p-4">
          <div>
            <p className="text-sm text-muted-foreground">{t("deletedCourse")}</p>
